...
namespace taskmaster_pro.Application.Interfaces
{
    ...
    public interface IGenericRepositoryAsync<T> where T : class
    {
        ...
        /// <summary>
        /// Retrieves a paged response of all entities from the database asynchronously with advanced sorting, and projection options.
        /// </summary>
        /// <param name="pageNumber">The page number to retrieve.</param>
        /// <param name="pageSize">The size of each page.</param>
        ...
        Task<IEnumerable<T>> GetPagedAdvancedReponseAsync(int pageNumber, int pageSize, string orderBy, string fields, Expression<Func<T, bool>> predicate);
