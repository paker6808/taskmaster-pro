namespace taskmaster_pro.WebApi.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static void AddSwaggerExtension(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Clean Architecture - taskmaster_pro.WebApi",
        ...
        public static void AddAuthorizationPolicies(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy(AuthorizationConsts.UserPolicy, policy => policy.RequireRole(user, admin)); // both can access if needed
            });
        }
    }
}
